(ns hxgm30.registration.repl
  (:require
    ...
    [hxgm30.registration.components.core]
...
(def setup-options {
  :init 'hxgm30.registration.components.core/init
  :after-refresh 'hxgm30.registration.repl/init-and-startup
  :throw-errors false})
